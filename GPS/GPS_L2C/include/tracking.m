...
for channelNr = 1:settings.numberOfChannels
    ...
    if (channel(channelNr).PRN ~= 0)
        ...
        fseek(fid,dataAdaptCoeff*(settings.skipNumberOfBytes + channel(channelNr).codePhase), 'bof');
        ...
        for loopCnt =  1:NumToProcess
            ...
            trackResults(channelNr).absoluteSample(loopCnt) = ((ftell(fid))/dataAdaptCoeff)/1 + 1 - remCodePhase/codePhaseStep;
