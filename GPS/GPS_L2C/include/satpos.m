...
A_REF          = 26559710;         % Reference value for semi-major axis, [meter]
omegaDot_REF   = -2.6e-9 * gpsPi;  % Reference value for rate of right ascension,
                                   % [rad/s]
