...
settings.codeLength           = 10230;       % CM code 
settings.codeFreqBasis        = 0.5115e6;    % [Hz]
settings.CLCodeLength         = 10230*75;    % CL code 

%% Acquisition settings ===================================================
% Skips acquisition in the script postProcessing.m if set to 1
settings.skipAcquisition        = 0;
% List of satellites to look for. Some satellites can be excluded to speed
% up acquisition (As of March 2017, there are 19 SVs transmitting L2C signals)
% settings.acqSatelliteList       = [8 10 16 23 31];
...
% Coherent integration time for acqisition
settings.acqCohT                = 20;             % [ms]
% Freq.search step
% settings.acqStep                = 1000/settings.acqCohT/2;  % [Hz]
settings.acqStep                = (1000/2)/20/2;  % [Hz]
% Sampling rate threshold for downsampling 
settings.resamplingThreshold    = 6e6;            % [Hz]
