function E1Ccode = generateE1Ccode(PRN)
% This function generates Galileo E1C  BOC(1,1)  code in bipolar 
...
E1Ccode = zeros(1, length(e1cCodeRaw)*2);
jj = 1;
for ii = 1:2:length(E1Ccode)-1
    E1Ccode(ii)   =  e1cCodeRaw(jj);
    E1Ccode(ii+1) = - e1cCodeRaw(jj);
    jj = jj + 1;
end
% Close the fid
fclose(fid);
